...
SERIES = {
    ...
    "treasury_2y": "DGS2",
    "gold_implied_vol": "GVZCLS",  # CBOE Gold ETF Volatility Index -- real implied vol from actual GLD options market prices, same methodology as VIX
    "oil_implied_vol": "OVXCLS",   # CBOE Crude Oil ETF Volatility Index -- same, from USO options
}
